  ...
  return (
    <div className="otto-roadmap-page otto-roadmap-howto-page animate-fade-in">
      ...
      <section className="otto-roadmap-info-card">
        ...
        <p>Прогресс не растёт от простого открытия задания. Он должен опираться на реальные выполненные упражнения и ваши результаты. Формула готовности будет учитывать накопленные данные по всем четырём навыкам.</p>
      </section>
