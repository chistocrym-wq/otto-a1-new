  ...
  return (
    <div className="otto-hub-screen animate-fade-in">
      ...
      <section className="otto-settings-list">
        <div className="otto-setting-row"><span><Globe2 /></span><div><strong>Язык интерфейса</strong><small>Интерфейс на русском, названия учебных модулей — на немецком</small></div></div>
